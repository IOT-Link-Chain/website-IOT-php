    ...
    <div class="hero-wrapper hero-1" id="hero">
        <div class="global-carousel" id="heroSlider1" data-fade="true" data-slide-show="1" data-arrows="true" data-xl-arrows="true" data-ml-arrows="true" data-lg-arrows="true" data-dots="true" data-xl-dots="true" data-ml-dots="true" data-lg-dots="true">
            <div class="hero-slider" data-bg-src="assets/img/hero/hero-bg-1-1.jpg">
                <div class="container">
                    <div class="row">
            ...
            <div class="hero-slider" data-bg-src="assets/img/hero/hero-bg-1-2.jpg">  
                <div class="container">
                    <div class="row">
                ...
                <div class="row gy-40 justify-content-lg-between justify-content-center">
                    <div class="col-sm-6 col-lg-auto">
                        <div class="counter-card">
                            ...
                            <p class="counter-card_text">Blocks Founds</p>
                        </div>
                    </div>
                    <div class="col-sm-6 col-lg-auto">
                        <div class="counter-card">
                            ...
                            <p class="counter-card_text">Transactions</p>
                        </div>
                    </div>
                    <div class="col-sm-6 col-lg-auto">
                        <div class="counter-card">
                            ...
                            <p class="counter-card_text">Holders</p>
                        </div>
                    </div>
                    <div class="col-sm-6 col-lg-auto">
                        <div class="counter-card">
                            ...
                            <p class="counter-card_text">Tokens isuued</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row justify-content-center">
                <div class="col-xl-12 col-lg-12">
                    <div class="title-area text-center">
                        <span class="sub-title">ROAD MAP PROCESS</span>
                        <h2 class="sec-title">Go green and reduce your carbon footprint with the iotlinkchain ecosystem.</h2>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-auto col-md-6 process-card-wrap">
                    <div class="process-card">
                        ...
                        <div class="process-card-icon">
                            <div class="process-num">Q3 24</div>
                        ...
                        <h5 class="process-card-title">
                            <div style="text-align: left; font-size:small;">
                            <li>Launch Network.</li>
                            <li>Wallet Web/EXtensions.</li>
                            <li>Wallet PC Win/Lin.</li>
                            <li>Token Issue Available.</li>
                            <li>Marketing/presale Phase.</li>
                            </div>
                    </h5>
                    </div>
                </div>
    ...
    Team Area  
    ==============================-->
    <div class="team-area-1 space-bottom overflow-hidden bg-smoke" data-bg-src="assets/img/bg/team-bg-1.svg">
        <div class="container container2">
            <div class="row justify-content-between">
                <div class="col-lg-12">
                    <div class="title-area text-center text-lg-start">
                        <span class="sub-title">OUR EXPERT TEAM</span>
                        <h2 class="sec-title">Experience & our Professionals Team</h2>
                    </div>
                </div>
            </div>
        </div>
        <div class="container container2">
            <div class="row gy-4">
                <div class="col-lg-6 team-card-wrap">
                    <div class="team-card">
                        <div class="team-img">
                            <img src="assets/img/team/1-1.jpg" alt="img">
                        </div>
                        <div class="team-card-content">
                            <h3 class="team-card-title">Liminha</h3>
                            <span class="team-card-desig">FOUNDER/DEVELOPER</span>
                            <p class="team-card-text">A naturalist is a person who studies the natural world, including plants, animals, and their environments.…</p>
                ...
                <div class="col-lg-6 team-card-wrap">
                    <div class="team-card">
                        <div class="team-img">
                            <img src="assets/img/team/1-2.jpg" alt="img">
                        </div>
                        <div class="team-card-content">
                            <h3 class="team-card-title">Jane</h3>
                            <span class="team-card-desig"> MARKETING/ADVISOR</span>
                            <p class="team-card-text">A naturalist is a person who studies the natural world, including plants, animals, and their environments.…</p>
                            <div class="social-btn">
                                <a href="#"><i class="fab fa-linkedin-in"></i></a>
                                <a href="#"><i class="fab fa-github"></i></a>
    ...
    <section class="blog-area space">
        <div class="container container2">
            <div class="row justify-content-between">
                <div class="col-lg-6">
                    <div class="title-area text-center text-lg-start">
                        <span class="sub-title">OUR LATEST New</span>
                        <h2 class="sec-title">Let’s checkout our all latest news</h2>
                    </div>
                </div>
                <div class="col-lg-5 text-lg-end text-center align-self-center">
                    <a href="?page=news" class="btn style4 mb-50 mb-lg-0">Read More<i class="fas fa-angle-double-right"></i></a>
                </div>
            </div>
        </div>
        <div class="container container2">
